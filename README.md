![Leadboard website](https://github.com/microverseinc/curriculum-javascript/blob/main/leaderboard/images/leaderboard_wireframe.png)
...
- *Recode game list from the user*
- *Add feature to fetch data for certain ID*
